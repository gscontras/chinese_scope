function make_slides(f) {
  ...
  {item: "dinosaurs",
    ...
    QUDs: {many: "How many dinosaurs eat the bugs?", all: "Did all of the dinosaurs eat bugs?", none: "Did none of the dinosaurs eat bugs?"}, 
  ...
  {item: "squirrels",
    ...
    QUDs: {many: "How many squirrels gathered acorns?", all: "Did all of the squirrels gather acorns?", none: "Did none of the suqirrels gather acorns?"}, 
  ...
  {item: "control5",
    ...
    QUDs: {many: "How many bunny went outside the cage?", all: "How many bunny went outside the cage?", none: "How many bunny went outside the cage?"}, 
