function make_slides(f) {
  ...
  slides.pretrial = slide({
    ...
    $("#practiceFeatures").html(stim["practice"]["feature"]);
  ...
  {item: "butterflies",
    contexts: {two: {without: {feature:"This story features two butterflies, a forest, and a city.",story: "Two butterflies were deciding where to go. First, they thought about the forest. One butterfly did not like the forest, but the other one did. They decided not to go to the forest. The first butterfly decided to go to the city. The other butterfly decided to go home instead."}, with: {feature: "This story features two butterflies, a forest, and a city.", story:"Two butterflies were deciding where to go. First, they thought about the forest, and decided to go. One butterfly did not like the forest, but the other one did. The butterfly who didn't like the forest decided to leave the forest and go to the city. The other butterfly decided to leave the forest and go home."}}, four: {without: {feature: "This story features four butterflies, a forest, and a city.", story: "Four butterflies were deciding where to go. First, they thought about the forest. Two butterflies did not like the forest, but the other two did. They decided not to go to the forest. The first two butterflies decided to go to the city. The other two butterflies decided to stay at home."}, with: {feature: "This story features four butterflies, a forest, and a city.", story: "Four butterflies were deciding where to go. First, they thought about the forest, and decided to go. Two of the butterflies did not like the forest, but the other two did. The butterflies who didn't like the forest decided to leave the forest and go to the city. The other two butterflies decided to leave the forest and go home."}}}, 
  ...
  {item: "lions",
    contexts: {two: {without: {feature: "This story features two lions, eggs, cookies, and a store.",story: "Two lions went into the store. They asked the owner what he had that they could eat. The store owner showed them eggs and cookies. The first lion bought a cookie. The other lion didn't buy anything."}, with: {feature: "This story features two lions, eggs, cookies, and store.",story: "Two lions went into the store looking for something to eat. They saw eggs and cookies. The two lions each bought an egg, and one of the lions also bought a cookie."}}, four: {without: {feature: "This story features four lions, eggs, cookies, and a store.", story: "Four lions went into the store. They asked store owner what food he was selling. The store owner showed them eggs and cookies. The first two lions each bought a cookie. The other two lions didn't buy anything."}, with: {feature: "This story features four lions, eggs, cookies, and a store.", story: "Four lions went into the store looking for something to eat. They saw eggs and cookies. All four lions bought eggs, and two of the lions bought cookies."}}}, 
    QUDs: {many: "How many lions bought a cookie?", all: "Did all of the lions buy a cookie?", none: "Did none of the lions buy a cookie?"}, 
    sentences: {every: "Every lion didn't buy a coockie.", numeral: "Two lions didn't buy a cookie."}},
  {item: "dinosaurs",
    contexts: {two: {without: {feature: "This story features two dinosaurs, bugs, and fish.", story: "Two dinosaurs were hungry and looking for food. The dinosaurs saw some fish in the river but decided they were too hard to catch. One dinosaur decided to eat a bug instead because bugs are easy to catch. The other dinosaur didn't eat anything."}, with: {feature: "This story features two dinosaurs, bugs, and fish.", story: "Two dinosaurs were hungry and looking for food. Each dinosaur ate a fish because fish are easy to catch. The dinosaurs then saw some bugs. One dinosaur was still hungry, so he decided to also eat a bug. The other dinosaur was too full after eating the fish so he didn't eat anything else."}}, four: {without: {feature: "This story features four dinosaurs, bugs, and fish.", story: "Four dinosaurs were hungry and looking for food. The dinosaurs saw some fish in the river but decided they were too hard to catch. Two dinosaurs decided to eat bugs instead because bugs are easy to catch. The other two dinosaurs didn't eat anything."}, with: {feature: "This story features four dinosaurs, bugs, and fish.", story: "Four dinosaurs were hungry and looking for food. Each dinosaur ate a fish because fish are easy to catch. The dinosaurs then saw some bugs. Two dinosaurs were still hungry, so they decided to also eat bugs. The other two dinosaurs were too full after eating the fish so they didn't eat anything else."}}}, 
  ...
  {item: "pigs",
    contexts: {two: {without: {feature: "This story features two pigs, logs, and straw.", story: "Two pigs were deciding how to build a house. First, the two pigs considered straw. They decided not to collect straw because straw is not sturdy. Then they considered logs. One pig thought that logs were sturdy, so he decided to collect logs. The other pig still thought that logs were not sturdy and didn't collect them."}, with: {feature: "This story features two pigs, logs and straw.", story: "Two pigs were deciding how to build a house. First, the two pigs considered straw and decided to collect straw to build the house. However, the wind destroyed their house. Then they considered logs. One pig thought that logs are sturdy, so he decided to collect logs. The other pig thought that logs are not sturdy and didn't collect them."}}, four: {without: {feature: "This story features four pigs, logs, and straw.", story: "Four pigs were deciding how to build a house. First, the four pigs considered straw. They decided not to collect straw because straw is not sturdy. Then they considered logs. Two pigs thought that logs were sturdy, so they decided to collect logs. The other two pigs still thought that logs were not sturdy and didn't collect them."}, with: {feature: "This story features four pigs, logs and straw.", story: "Four pigs were deciding how to build a house. First, the four pigs considered straw and decided to collect straw to build the house. However, the wind destroyed their house. Then they considered logs. Two pigs thought that logs are sturdy, so they decided to collect logs. The other two pigs thought that logs are not sturdy and didn't collect them."}}}, 
  ...
  {item: "squirrels",
    contexts: {two: {without: {feature: "This story features two squirrels, acorns, and walnuts.", story: "Two squirrels were gathering food for the coming winter. First, the two squirrels saw walnuts, but they didn't like walnuts. Then, the two squirrels saw acorns. One squirrel decided to gather acorns. The other squirrel didn't like acorns either so she didn't gather anything."}, with: {feature: "This story features two squirrels, acorns, and walnuts.", story: "Two squirrels were gathering food for the coming winter. First, the two squirrels saw walnuts and gathered them. After a while, one squirrel got tired of walnuts and started gathering acorns instead."}}, four: {without: {feature: "This story features four squirrels, acorns, and walnuts.", story: "Four squirrels were gathering food for the coming winter. First, the four squirrels saw walnuts, but they didn't like walnuts. Then, four squirrels saw acorns. Two squirres decided to gather acorns. The other two squirrels didn't like walnuts either so they didn't gather anything."}, with: {feature: "This story features four squirrels, acorns, and walnuts.", story: "Four squirrels were gathering food for the coming winter. First, the four squirrels saw walnuts and gathered them. After a while, two squirrels got tired of walnuts and started gathering acorns instead."}}}, 
  ...
  {item: "foxes",
    contexts: {two: {without: {feature: "This story features two foxes, grapes, strawberries, and a cake.", story: "Two foxes decided to make a cake, so they went to pick fruit. First, the two foxes saw grapes. They thought that grapes were too sour, so they didn't pick grapes. Then, they saw strawberries. One fox picked some strawberries. The other fox didn't pick anything, because he still thought that strawberries were too sour."}, with: {feature: "This story features two foxes, grapes, strawberries, and a cake.", story: "Two foxes decided to make a cake, so they went to pick fruit. First, the two foxes saw grapes and picked some grapes. Then, two foxes saw strawberries. One fox picked some strawberries. The other fox thought that strawberries were too sour and didn't pick them."}}, four: {without: {feature: "This story features four foxes, grapes, strawberries, and a cake.", story: "Four foxes decided to make a cake, so they went to pick fruit. First, the four foxes saw grapes. They thought that grapes were too sour, so they didn't pick grapes. Then, they saw strawberries. Two foxes picked some strawberries. The other two foxes didn't pick anything, because they still thought that strawberries were too sour."}, with: {feature: "This story features four foxes, grapes, strawberries, and a cake.", story: "Four foxes decided to make a cake, so they went to pick fruit. First, the four foxes saw grapes and picked some grapes. Then, four foxes saw strawberries. Two foxes picked some strawberries. The other two foxes thought that strawberries were too sour and didn't pick them."}}}, 
  ...
  {item: "monkeys",
    contexts: {two: {without: {feature: "This story features two monkeys, an oak, and a palm tree.", story: "Two monkeys were looking for a place to live. First, they looked at an oak. They concluded that the oak was too short to guarantee their safety. Then, the two monkeys looked at a palm tree. One monkey climbed on the palm tree. The other monkey still thought that the palm tree was too short, so he didn't climb on any trees."}, with: {feature: "This story features two monkeys, an oak, and a palm tree.", story: "Two monkeys were looking for a place to live. First, they looked at an oak, and climbed on it. One monkey thought that the oak was too short to guarantee his safety, so he decided to find another tree. The monkey who looked for another tree climbed on a palm tree. The other monkey stayed on the oak."}}, four: {without: {feature: "This story features four monkeys, an oak, and a palm tree.", story: "Four monkeys were looking for a place to live. First, they looked at an oak. They concluded that the oak was too short to guarantee their safety. Then, the four monkeys looked at a palm tree. Two monkeys climbed on the palm tree. The other two monkeys still thought that the palm tree was too short, so they didn't climb on any trees."}, with: {feature: "This story features four monkeys, an oak, and a palm tree.", story: "Four monkeys were looking for a place to live. First, they looked at an oak, and climbed on it. Two monkeys thought that the oak was too short to guarantee their safety, so they decided to find another tree. The two monkeys who looked for another tree climbed on a palm tree. The other two monkeys stayed on the oak."}}}, 
  ...
  {item: "penguins",
    contexts: {two: {without: {feature: "This story features two penguins, a polar bear, fish, and a lobster.", story: "Two penguins were going to visit their friend, a polar bear, and they wanted to bring a gift. First, the two penguins thought about a lobster, but they decided it was too expensive as a gift. Then they thought about fish. One penguin decided to bring a fish as a gift. The other penguin didn't like the fish and brought nothing instead."}, with: {feature: "This story features two penguins, a polar bear, fish, and a lobster.", story: "Two penguins were going to visit their friend, a polar bear, and they wanted to bring a gift. The two penguins decided to bring a lobster. One penguin thought that a lobster was not enough, so that penguin also decided to bring a fish. The other penguin only brought a lobster."}}, four: {without: {feature: "This story features four penguins, a polar bear, fish, and a lobster.", story: "Four penguins were going to visit their friend, a polar bear, and they wanted to bring a gift. First, they thought about a lobster, but they decided that a lobster was too expensive as a gift. Then, the four penguins thought about fish. Two penguins decided to bring a fish as a gift. The other two penguins didn't like the fish and brought nothing instead."}, with: {feature: "This story features four penguins, a polar bear, fish, and lobster.", story: "Four penguins were going to visit their friend, a polar bear, and they wanted to bring a gift. First, they thought about a lobster as a gift. Two penguins thought that a lobster was not enough, so they also decided to bring a fish. The other two penguins only brought a lobster."}}}, 
  ...
  {item: "fairies",
    contexts: {two: {without: {feature: "This story features two fairies, a castle, violin, and guitar.", story: "There was a celebration in a castle. Two fairies were deciding to have a concert for the celebration. First, they thought about playing the violin. One fairy didn't liked the violin, so she decided to play the guitar. The other fairy didn't play anything."}, with: {feature: "This story features two fairies, a castle, violin, and guitar.", story: "There was a celebration in a castle. Two fairies were deciding to have a concert for the celebration. First, they decided to play the violin. One fairy didn't like the sound the violin made, so she decided to play the guitar instead. The other fairy kept playing the violin."}}, four: {without: {feature: "This story features four fairies, a castle, violin, and guitar.", story: "There was a celebration in a castle. Four fairies were deciding to have a concert for the celebration. First, they thought about playing the violin. Two fairies didn't like the violin, so they decided to play the guitar. The other two fairies didn't play anything."}, with: {feature: "This story features four fairies, a castle, violin, and guitar.", story: "There was a celebration in a castle. Four fairies were deciding to have a concert for the celebration. First, they decided to play the violin. Two fairies didn't like the sound the violin made, so they decided to play the guitar instead. The other two fairies kept playing the violin."}}}, 
  ...
  {item: "bears",
    contexts: {two: {without: {feature: "This story features two bears, science books, story books, and a library.", story: "Two bears went to the library to borrow books. Science books and story books were available to borrow. One bear borrowed a science book, but the other bear didn't borrow anything."}, with: {feature: "This story features two bears, science books, story books, and a library.", story: "Two bears went to the library to borrow books. Science books and story books were available to borrow. Both two bears borrowed a story book, and one bear also borrowed a science book."}}, four: {without: {feature: "This story features four bears, science books, story books, and a library.", story: "Four bears went to the library to borrow books. Science books and story books were available to borrow. Two bears borrowed a science book, but the other two bears didn't borrow anything."}, with: {feature: "This story features four bears, science books, story books, and a library.", story: "Four bears went to the library to borrow books. Science books and story books were available to borrow. Four bears borrowed a story book, and two bears also borrowed a science book."}}}, 
  ...
  {item: "pandas",
    contexts: {two: {without: {feature: "This story features two pandas, a gym, and a fitness coach.", story: "Two pandas went to the gym to lose weight. First, the fitness coach asked them to run a mile. The two pandas thought that running was too hard. Then, the coach asked them to practice Kung Fu for two hours. One panda decided to practice Kung Fu, but the other panda was too lazy and did nothing."}, with: {feature: "This story features two pandas, a gym, and a fitness coach.", story: "Two pandas went to the gym to lose weight. First, the fitness coach asked them to run a mile. The two pandas ran a mile. Then, the coach asked them to practice Kung Fu for two hours. One panda decided to practice Kung Fu, but the other panda decided to take a rest."}}, four: {without: {feature: "This story features four pandas, a gym, and a fitness coach.", story: "Four pandas went to the gym to lose weight. First, the fitness coach asked them to run a mile. The four pandas thought that running was too hard. Then, the coach asked them to practice Kung Fu for two hours. Two pandas decided to practice Kung Fu, but the other two pandas were too lazy and did nothing."}, with: {feature: "This story features four pandas, a gym, and a fitness coach.", story: "Four pandas went to the gym to lose weight. First, the fitness coach asked them to run a mile. The four pandas ran a mile. Then, the coach asked them to practice Kung Fu for two hours. Two pandas decided to practice Kung Fu, but the other two pandas decided to take a rest."}}}, 
  ...
  {item: "control1",
    contexts: {two: {without: {feature: "This story features two hippos and two cartons of milk.", story: "Two hippos were very thirsty and were looking for water to drink. The only thing they could find to drink was milk. They both decided to drink the milk."}, with: {feature: "This story features two hippos and two cartons of milk.", story: "Two hippos were very thirsty and were looking for water to drink. The only thing they could find to drink was milk. They both decided to drink the milk."}}, four: {without: {feature: "This story features two hippos and two cartons of milk.", story:"Two hippos were very thirsty and were looking for water to drink. The only thing they could find to drink was milk. They both decided to drink the milk."}, with: {feature: "This story features two hippos and two cartons of milk.", story: "Two hippos were very thirsty and were looking for water to drink. The only thing they could find to drink was milk. They both decided to drink the milk."}}}, 
    QUDs: {many: "How many hippos drank milk?", all: "How many hippos drank milk?", none: "How many hippos drank milk?"}, 
    sentences: {every: "Three hippos drank milk.", numeral: "Three hippos drank milk."}},
  {item: "control2",
    contexts: {two: {without: {feature: "This story features two dogs and two balls.", story: "Two dogs were playing, and each had a ball. The first dog decided to roll its ball across the table. The second dog decided not to roll its ball, because it was afraid its ball might roll off the table."}, with: {feature: "This story features two dogs and two balls.", story: "Two dogs were playing, and each had a ball. The first dog decided to roll its ball across the table. The second dog decided not to roll its ball, because it was afraid its ball might roll off the table."}}, four: {without: {feature: "This story features two dogs and two balls.", story: "Two dogs were playing, and each had a ball. The first dog decided to roll its ball across the table. The second dog decided not to roll its ball, because it was afraid its ball might roll off the table."}, with: {feature: "This story features two dogs and two balls.", story: "Two dogs were playing, and each had a ball. The first dog decided to roll its ball across the table. The second dog decided not to roll its ball, because it was afraid its ball might roll off the table."}}}, 
  ...
  {item: "control3",
    contexts: {two: {without: {feature: "This story features four lizards and a book.", story: "Four lizards were sunning themselves when one of the lizards thought they would get more sun on top of the book. Two of the lizards jumped on the book. The other two lizards decided the book was too high and decided not to jump."}, with: {feature: "This story features four lizards and a book.", story: "Four lizards were sunning themselves when one of the lizards thought they would get more sun on top of the book. Two of the lizards jumped on the book. The other two lizards decided the book was too high and decided not to jump."}}, four: {without: {feature: "This story features four lizards and a book.",story: "Four lizards were sunning themselves when one of the lizards thought they would get more sun on top of the book. Two of the lizards jumped on the book. The other two lizards decided the book was too high and decided not to jump."}, with: {feature: "This story features four lizards and a book." ,story: "Four lizards were sunning themselves when one of the lizards thought they would get more sun on top of the book. Two of the lizards jumped on the book. The other two lizards decided the book was too high and decided not to jump."}}}, 
  ...
  {item: "control4",
    contexts: {two: {without: {feature: "This story features four cats and a fish.", story: "Four cats decided to go fishing. The first cat caught a fish. The second cat caught a fish. The third cat and the fourth cat did not catch any fish."}, with: {feature: "This story features four cats and fish.", story: "Four cats decided to go fishing. The first cat caught a fish. The second cat caught a fish. The third cat and the fourth cat did not catch any fish."}}, four: {without: {feature: "This story features four cats and fish.", story: "Four cats decided to go fishing. The first cat caught a fish. The second cat caught a fish. The third cat and the fourth cat did not catch any fish."}, with: {feature: "This story features four cats and fish.", story: "Four cats decided to go fishing. The first cat caught a fish. The second cat caught a fish. The third cat and the fourth cat did not catch any fish."}}}, 
  ...
  {item: "control5",
    contexts: {two: {without: {feature: "This story features three bunnies and a cage.", story: "Three bunnies were deciding to take an adventure. The first bunny went outside the cage. The second bunny went outside the cage. And the third bunny went outside the cage as well."}, with: {feature: "This story features three bunnies and a cage.", story: "Three bunnies were deciding to take an adventure. The first bunny went outside the cage. The second bunny went outside the cage. And the third bunny went outside the cage as well."}}, four: {without: {feature: "This story features three bunnies and a cage.", story: "Three bunnies were deciding to take an adventure. The first bunny went outside the cage. The second bunny went outside the cage. And the third bunny went outside the cage as well."}, with: {feature: "This story features three bunnies and a cage.", story: "Three bunnies were deciding to take an adventure. The first bunny went outside the cage. The second bunny went outside the cage. And the third bunny went outside the cage as well."}}}, 
  ...
  {item: "control6",
    contexts: {two: {without: {feature: "This story features two owls and thieves.", story: "Two owls were trying to catch thieves. At night, the first owl caught a thief, but the second owl did not catch any thieves."}, with: {feature: "This story features two owls and thieves.", story: "Two owls were trying to catch thieves. At night, the first owl caught a thief, but the second owl did not catch any thieves."}}, four: {without: {feature: "This story features two owls and thieves.", story: "Two owls were trying to catch thieves. At night, the first owl caught a thief, but the second owl did not catch any thieves."}, with: {feature: "This story features two owls and thieves.", story: "Two owls were trying to catch thieves. At night, the first owl caught a thief, but the second owl did not catch any thieves."}}}, 
  ...
  {item: "control7",
    contexts: {two: {without: {feature: "This story features two kids and candies.", story: "Two kids were deciding to share their candies with each other. The first kid gave candy to the second kid. The second kid did not give candy to the first kid."}, with: {feature: "This story features two kids and candies.", story: "Two kids were deciding to share their candies with each other. The first kid gave candy to the second kid. The second kid did not give candy to the first kid."}}, four: {without: {feature: "This story features two kids and candies.", story: "Two kids were deciding to share their candies with each other. The first kid gave candy to the second kid. The second kid did not give candy to the first kid."}, with: {feature: "This story features two kids and candies.", story: "Two kids were deciding to share their candies with each other. The first kid gave candy to the second kid. The second kid did not give candy to the first kid."}}}, 
  ...
  {item: "control8",
    contexts: {two: {without: {feature: "This story features three pigeons.", story: "Three pigeons were migrating from the north to the south. The pigeons flew in a straight line."}, with: {feature: "This story features three pigeons.", story: "Three pigeons were migrating from the north to the south. The pigeons flew in a straight line."}}, four: {without: {feature: "This story features three pigeons.", story: "Three pigeons were migrating from the north to the south. The pigeons flew in a straight line."}, with: {feature: "This story features three pigeons.", story: "Three pigeons were migrating from the north to the south. The pigeons flew in a straight line."}}}, 
