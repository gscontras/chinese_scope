function make_slides(f) {
  ...
  {item: "control3",
    contexts: {two: {without: {feature: "This story features four lizards and a book.", story: "Four lizards were sunning themselves when one of the lizards thought they would get more sun on top of the book. Two of the lizards jumped on the book. The other two lizards decided the book was too high and decided not to jump."}, with: {feature: "This story features four lizards and a book.", story: "Lizards were sunning themselves when one of the lizards thought they would get more sun on top of the book. Two of the lizards jumped on the book. The other two lizards decided the book was too high and decided not to jump."}}, four: {without: {feature: "This story features four lizards and a book.",story: "Lizards were sunning themselves when one of the lizards thought they would get more sun on top of the book. Two of the lizards jumped on the book. The other two lizards decided the book was too high and decided not to jump."}, with: {feature: "This story features four lizards and a book." ,story: "Lizards were sunning themselves when one of the lizards thought they would get more sun on top of the book. Two of the lizards jumped on the book. The other two lizards decided the book was too high and decided not to jump."}}}, 
  ...
  {item: "control4",
    contexts: {two: {without: {feature: "This story features four cats and a fish.", story: "Four cats decided to go fishing. The first cat caught a fish. The second cat caught a fish. The third cat and the fourth cat did not catch any fish."}, with: {feature: "This story features four cats and fish.", story: "Four cats were deciding to go fishing. The first cat caught a fish. The second cat caught a fish. The third cat and the fourth cat did not catch any fish."}}, four: {without: {feature: "This story features four cats and fish.", story: "Four cats were deciding to go fishing. The first cat caught a fish. The second cat caught a fish. The third cat and the fourth cat did not catch any fish."}, with: {feature: "This story features four cats and fish.", story: "Four cats were deciding to go fishing. The first cat caught a fish. The second cat caught a fish. The third cat and the fourth cat did not catch any fish."}}}, 
