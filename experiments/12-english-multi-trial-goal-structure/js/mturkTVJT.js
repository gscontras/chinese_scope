function make_slides(f) {
 ...
 //  });
  ...
  {item: "hippos",
    ...
    goals: {many:"what did the hippos drink", all:"what did the hippos drink", none:"what did the hippos drink"},
  ...
  {item: "bunnies",
    ...
    goals: {many:"why did the bunnies go outside the cage", all:"why did the bunnies go outside the cage", none:"why did the bunnies go outside the cage"},
