function make_slides(f) {
 ...
 //  });
  ...
  {item: "control",
    topic: "hippos",
    contexts: {two: {without: "This story features two hippos and two cartons of milk. The two hippos were very thirsty and were looking for water to drink. The only thing they could find to drink was milk. They both decided to drink the milk.", with: "This story features two hippos and two cartons of milk. The two hippos were very thirsty and were looking for water to drink. The only thing they could find to drink was milk. They both decided to drink the milk."}, four: {without: "This story features two hippos and two cartons of milk. The two hippos were very thirsty and were looking for water to drink. The only thing they could find to drink was milk. They both decided to drink the milk.", with: "This story features two hippos and two cartons of milk. The two hippos were very thirsty and were looking for water to drink. The only thing they could find to drink was milk. They both decided to drink the milk."}}, 
    QUDs: {many: "What did the hippos drink?", all: "What did the hippos drink?", none: "What did the hippos drink?"}, 
    goals: {many:"what the hippos had to drink", all:"what the hippos had to drink", none:"what the hippos had to drink"},
    bins: {many: {two: "<img src = \"expt_files/bins/control-hippo/hippos-drank-water.png\" width=\"140\"><img src = \"expt_files/bins/control-hippo/hippos-drank-milk.png\" width=\"140\">", four: "<img src = \"expt_files/bins/control-hippo/hippos-drank-water.png\" width=\"140\"><img src = \"expt_files/bins/control-hippo/hippos-drank-milk.png\" width=\"140\">"}, all: {two: "<img src = \"expt_files/bins/control-hippo/hippos-drank-water.png\" width=\"140\"><img src = \"expt_files/bins/control-hippo/hippos-drank-milk.png\" width=\"140\">", four: ["<img src = \"expt_files/bins/control-hippo/hippos-drank-water.png\" width=\"140\"><img src = \"expt_files/bins/control-hippo/hippos-drank-milk.png\" width=\"140\">"]}, none: {two: "<img src = \"expt_files/bins/control-hippo/hippos-drank-water.png\" width=\"140\"><img src = \"expt_files/bins/control-hippo/hippos-drank-milk.png\" width=\"140\">", four: ["<img src = \"expt_files/bins/control-hippo/hippos-drank-water.png\" width=\"140\"><img src = \"expt_files/bins/control-hippo/hippos-drank-milk.png\" width=\"140\">"]}},
    sentences: {every: "\"Two hippos drank milk.\"", numeral: "\"Two hippos drank milk.\""}},
  // {item: "control2",
  ...
  {item: "control",
    topic: "bunnies",
    contexts: {two: {without: "This story features three bunnies and a cage. The three bunnies were deciding whether to take an adventure. The first bunny went outside the cage. The second bunny went outside the cage. And the third bunny went outside the cage as well.", with: "This story features three bunnies and a cage. The three bunnies were deciding whether to take an adventure. The first bunny went outside the cage. The second bunny went outside the cage. And the third bunny went outside the cage as well."}, four: {without: "This story features three bunnies and a cage. The three bunnies were deciding whether to take an adventure. The first bunny went outside the cage. The second bunny went outside the cage. And the third bunny went outside the cage as well.", with: "This story features three bunnies and a cage. The three bunnies were deciding whether to take an adventure. The first bunny went outside the cage. The second bunny went outside the cage. And the third bunny went outside the cage as well."}}, 
    QUDs: {many: "Why did the bunnies go outside the cage?", all: "Why did the bunnies go outside the cage?", none: "Why did the bunnies go outside the cage?"}, 
    goals: {many:"why the bunnies went outside the cage", all:"why the bunnies went outside the cage", none:"why the bunnies went outside the cage"},
    bins: {many: {two: "<img src = \"expt_files/bins/control-bunny/bunnies-adventure.png\" width=\"140\"><img src = \"expt_files/bins/control-bunny/bunnies-food.png\" width=\"140\">", four: "<img src = \"expt_files/bins/control-bunny/bunnies-adventure.png\" width=\"140\"><img src = \"expt_files/bins/control-bunny/bunnies-food.png\" width=\"140\">"}, all: {two: "<img src = \"expt_files/bins/control-bunny/bunnies-adventure.png\" width=\"140\"><img src = \"expt_files/bins/control-bunny/bunnies-food.png\" width=\"140\">", four: ["<img src = \"expt_files/bins/control-bunny/bunnies-adventure.png\" width=\"140\"><img src = \"expt_files/bins/control-bunny/bunnies-food.png\" width=\"140\">"]}, none: {two: "<img src = \"expt_files/bins/control-bunny/bunnies-adventure.png\" width=\"140\"><img src = \"expt_files/bins/control-bunny/bunnies-food.png\" width=\"140\">", four: ["<img src = \"expt_files/bins/control-bunny/bunnies-adventure.png\" width=\"140\"><img src = \"expt_files/bins/control-bunny/bunnies-food.png\" width=\"140\">"]}},
    sentences: {every: "\"Every bunny is going on an adventure.\"", numeral: "\"Every bunny is going on an adventure.\""}},  
  // {item: "control6",
  ...
  {item: "control",
    ...
    QUDs: {many: "Who shared their candy?", all: "Who shared their candy?", none: "Who shared their candy?"}, 
    goals: {many:"who shared their candy", all:"who shared their candy", none:"who shared their candy"},
    bins: {many: {two: "<img src = \"expt_files/bins/control-kid/first-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/second-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/both-kids-shared.png\" width=\"140\">", four: "<img src = \"expt_files/bins/control-kid/first-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/second-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/both-kids-shared.png\" width=\"140\">"}, all: {two: "<img src = \"expt_files/bins/control-kid/first-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/second-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/both-kids-shared.png\" width=\"140\">", four: ["<img src = \"expt_files/bins/control-kid/first-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/second-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/both-kids-shared.png\" width=\"140\">"]}, none: {two: "<img src = \"expt_files/bins/control-kid/first-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/second-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/both-kids-shared.png\" width=\"140\">", four: ["<img src = \"expt_files/bins/control-kid/first-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/second-kid-shared.png\" width=\"140\"><img src = \"expt_files/bins/control-kid/both-kids-shared.png\" width=\"140\">"]}},
    sentences: {every: "\"Every kid shared their candy.\"", numeral: "\"Every kid shared their candy.\""}},
  {item: "control",
    topic: "pigeons",
    ...
    QUDs: {many: "Where were the pigeons flying?", all: "Where were the pigeons flying?", none: "Where were the pigeons flying?"}, 
    goals: {many:"where the pigeons were flying", all:"where the pigeons were flying", none:"where the pigeons were flying"},
    bins: {many: {two: "<img src = \"expt_files/bins/control-pigeon/pigeons-flew-north.png\" width=\"140\"><img src = \"expt_files/bins/control-pigeon/pigeons-flew-south.png\" width=\"140\">", four: "<img src = \"expt_files/bins/control-pigeon/pigeons-flew-north.png\" width=\"140\"><img src = \"expt_files/bins/control-pigeon/pigeons-flew-south.png\" width=\"140\">"}, all: {two: "<img src = \"expt_files/bins/control-pigeon/pigeons-flew-north.png\" width=\"140\"><img src = \"expt_files/bins/control-pigeon/pigeons-flew-south.png\" width=\"140\">", four: ["<img src = \"expt_files/bins/control-pigeon/pigeons-flew-north.png\" width=\"140\"><img src = \"expt_files/bins/control-pigeon/pigeons-flew-south.png\" width=\"140\">"]}, none: {two: "<img src = \"expt_files/bins/control-pigeon/pigeons-flew-north.png\" width=\"140\"><img src = \"expt_files/bins/control-pigeon/pigeons-flew-south.png\" width=\"140\">", four: ["<img src = \"expt_files/bins/control-pigeon/pigeons-flew-north.png\" width=\"140\"><img src = \"expt_files/bins/control-pigeon/pigeons-flew-south.png\" width=\"140\">"]}},
    sentences: {every: "\"Every pigeon flew south.\"", numeral: "\"Every pigeon flew south.\""}},
 ...
 //  {twowithout: {story: "", sentence: "\"\"", item: ""}, twowith: {story: "", sentence: "\"\"", item: ""}, fourwithout: {story: "", sentence: "\"\"", item: ""}, fourwith: {story: "", sentence: "\"\"", item: ""}, everywithout: {story: "", sentence: "\"\"", item: ""}, everywith: {story: "", sentence: "\"\"", item: ""}, questions: {all: "\"\"", none: "\"\"", how_many: "\"\" "}},
    ...
    present_handle : function(stim) {
      ...
      exp.quantifier = _.sample(["every","numeral","numeral"])
      ...
      exp.item = stim["item"]
      exp.topic = stim["topic"]

      $("#topic").html(exp.topic)
      ...
      if (exp.quantifier == "every") {
	    ...
	    $("#expStoryStory").html(stim["contexts"][exp.number][exp.context]);
