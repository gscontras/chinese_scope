function make_slides(f) {
  ...
  {item: "frogs",
    ...
    goals: {many:"how many frogs jump over rocks", all:"whether all the frogs jump over rocks", none:"whether none of the frogs jump over rocks"},
    bins: {many: {two: "<img src = \"expt_files/bins/Frog-story/Many-two/0-frogs-jump.png\" width=\"130\"><img src = \"expt_files/bins/Frog-story/Many-two/1-frog-jumps.png\" width=\"130\"><img src = \"expt_files/bins/Frog-story/Many-two/2-frogs-jump.png\" width=\"130\">", four: "<img src = \"expt_files/bins/Frog-story/Many-four/0-frogs-jump.png\" width=\"130\"><img src = \"expt_files/bins/Frog-story/Many-four/1-frog-jumps.png\" width=\"130\"><img src = \"expt_files/bins/Frog-story/Many-four/2-frogs-jump.png\" width=\"130\"><img src = \"expt_files/bins/Frog-story/Many-four/3-frogs-jump.png\" width=\"130\"><img src = \"expt_files/bins/Frog-story/Many-four/4-frogs-jump.png\" width=\"130\">"}, all: {two: "<img src = \"expt_files/bins/all-frogs-jump.png\" width=\"130\"><img src = \"expt_files/bins/some-frogs-dont-jump.png\" width=\"130\">", four: ["all frogs jump", "some frogs don't jump"]}, none: {two: "<img src = \"expt_files/bins/Frog-story/None-two/some-frogs-jump.png\" width=\"130\"><img src = \"expt_files/bins/Frog-story/None-two/no-frogs-jump.png\" width=\"130\">", four: ["no frogs jump", "some frogs jump"]}},
  ...
  {item: "butterflies",
    ...
    bins: {many: {two: "<img src = \"expt_files/bins/butterfly-story/many-two/0-butterflies-city.png\" width=\"130\"><img src = \"expt_files/bins/butterfly-story/many-two/1-butterfly-city.png\" width=\"130\"><img src = \"expt_files/bins/butterfly-story/many-two/2-butterflies-city.png\" width=\"130\">", four: "<img src = \"expt_files/bins/butterfly-story/many-four/0-butterflies-city.png\" width=\"130\"><img src = \"expt_files/bins/butterfly-story/many-four/1-butterfly-city.png\" width=\"130\"><img src = \"expt_files/bins/butterfly-story/many-four/2-butterflies-city.png\" width=\"130\"><img src = \"expt_files/bins/butterfly-story/many-four/3-butterflies-city.png\" width=\"130\"><img src = \"expt_files/bins/butterfly-story/many-four/4-butterflies-city.png\" width=\"130\">"}, all: {two: "<img src = \"expt_files/bins/butterfly-story/all-two/all-butterflies-went.png\" width=\"130\"><img src = \"expt_files/bins/butterfly-story/all-two/some-butterflies-didnt-go.png\" width=\"130\">", four: ["all butterflies went to the city", "some butterflies didn't go to the city"]}, none: {two: "<img src = \"expt_files/bins/butterfly-story/none-two/no-butterfly-went.png\" width=\"130\"><img src = \"expt_files/bins/butterfly-story/none-two/some-butterflies-went.png\" width=\"130\">", four: ["no butterflies went", "some butterflies went"]}},
