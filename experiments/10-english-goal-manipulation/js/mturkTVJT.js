function make_slides(f) {
  ...
  {item: "frogs",
    ...
    bins: {many: {two: "<img src = \"expt_files/bins/Frog-story/Many-two/0-frogs-jump.png\" width=\"130\"><img src = \"expt_files/bins/Frog-story/Many-two/1-frog-jumps.png\" width=\"130\"><img src = \"expt_files/bins/Frog-story/Many-two/2-frogs-jump.png\" width=\"130\">", four: ["0","1","2","3","4"]}, all: {two: "<img src = \"expt_files/bins/all-frogs-jump.png\" width=\"130\"><img src = \"expt_files/bins/some-frogs-dont-jump.png\" width=\"130\">", four: ["all frogs jump", "some frogs don't jump"]}, none: {two: "<img src = \"expt_files/bins/Frog-story/None-two/some-frogs-jump.png\" width=\"130\"><img src = \"expt_files/bins/Frog-story/None-two/no-frogs-jump.png\" width=\"130\">", four: ["no frogs jump", "some frogs jump"]}},
