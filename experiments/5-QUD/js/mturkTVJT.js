  ...
  slides.one_slider_practice = slide({
    ...
    /* trial information for this block
     (the variable 'stim' will change between each of these values,
  	...
  	present : [
  		{practice: {story: "这个故事中有一个蓝精灵，一个售货员，和五辆车。蓝精灵想买一辆车。刚开始，售货员给他展示了一辆银色的敞篷汽车。蓝精灵很喜欢，并且用两便士买下了它。售货员又给他展示了一辆黄色的车。蓝精灵很喜欢，并且用两便士买下了它。蓝精灵只剩下一便士了，所以它决定结束购买。", sentence: "\"蓝精灵买了两辆车。\"", question: "what happened?"}},
